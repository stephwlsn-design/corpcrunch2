  ...
  const defaultTeam = [
    {
      name: 'John Carter',
      role: 'Co-founder',
      imageUrl: '/assets/img/team/john-carter.jpg',
    },
    {
      name: 'Michael Reed',
      role: 'Lead Web Developer',
      imageUrl: '/assets/img/team/michael-reed.jpg',
    },
    {
      name: 'David Walker',
      role: 'Front-End Engineer',
      imageUrl: '/assets/img/team/david-walker.jpg',
    },
    {
      name: 'James Nolan',
      role: 'Back-End Specialist',
      imageUrl: '/assets/img/team/james-nolan.jpg',
    },
  ];
  ...
  return (
    <section className={styles.expertsSection}>
      ...
      <div className={styles.verticalTextLeft}>
        ...
        <div className={styles.verticalTextBottom}>DEVELOPMENT*AGENCY</div>
      </div>
          ...
          {displayTeam.map((member, index) => (
            <div key={index} className={styles.teamCard}>
              <div className={styles.imageWrapper}>
                <Image
                  src={member.imageUrl || '/assets/img/placeholder-team.jpg'}
                  alt={member.name}
                  fill
              ...
              <div className={styles.teamInfo}>
                <h3 className={styles.teamName}>{member.name?.toUpperCase() || 'TEAM MEMBER'}</h3>
                <p className={styles.teamRole}>{member.role || 'Team Member'}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      {/* Bottom Border */}
      <div className={styles.sectionBorderBottom}></div>
    </section>
  );
}
