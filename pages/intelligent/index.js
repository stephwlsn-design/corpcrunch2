            ...
            <div className={styles.pageContainer}>
                ...
                <div className={styles.tabFadeIn}>
                  ...
                  <section id="portfolio" className={`${styles.section} ${styles.observeTrigger} ${visibleSections['portfolio'] ? styles.isVisible : ''}`}>
                    ...
                    <div className={styles.carouselWrapper}>
                      ...
                      <div className={`${styles.portfolioCard} ${styles.bgBlue} ${styles.carouselCard}`}>
                ...
                <div className={styles.tabFadeIn}>
                  ...
                  <section id="arch-deep" className={`${styles.section} ${styles.observeTrigger} ${visibleSections['arch-deep'] ? styles.isVisible : ''}`}>
                    ...
                    <div className={styles.archContainer}>
                      <div className={styles.archFlowWrapper}>
                        ...
                        <div className={styles.archStep}><div className={`${styles.archPill} ${styles.bgLightBlue}`}>ORCHESTRATION ENGINE</div><div className={styles.archDesc}>Zero-loss routing | Cross-system synchronisation | Event-driven architecture</div></div>
                        ...
                        <div className={styles.archStep}><div className={`${styles.archPill} ${styles.bgBlue}`}>UNIFIED INTELLIGENCE LAYER</div><div className={styles.archDesc} style={{color: '#2b4cff', fontWeight: '500'}}>Single coherent interface | Adaptive workflows | Real-time decision support</div></div>
                  ...
                  <section id="positioning" className={`${styles.section} ${styles.observeTrigger} ${visibleSections['positioning'] ? styles.isVisible : ''}`}>
                    ...
                    <div className={styles.compareGrid2Col}>
                      <div className={`${styles.comparePill} ${styles.bgBlue}`}>Dimension</div><div className={`${styles.comparePill} ${styles.bgBlue}`}>Corp Crunch™</div>
                      <div className={`${styles.comparePill} ${styles.bgDark}`}>AI Approach</div><div className={`${styles.comparePill} ${styles.bgBlue}`}>Infrastructure-embedded, AI-native architecture from the ground up</div>
                      <div className={`${styles.comparePill} ${styles.bgLightGrey}`}>Data Orchestration</div><div className={`${styles.comparePill} ${styles.bgBlue}`}>Real-time, sub-millisecond pipelines with zero-loss routing</div>
                      <div className={`${styles.comparePill} ${styles.bgDark}`}>Risk Analytics</div><div className={`${styles.comparePill} ${styles.bgBlue}`}>Embedded ML risk models with live outcome forecasting</div>
                      <div className={`${styles.comparePill} ${styles.bgLightGrey}`}>ML Operations</div><div className={`${styles.comparePill} ${styles.bgBlue}`}>Proprietary continuous learning loops with auto-retraining</div>
                      <div className={`${styles.comparePill} ${styles.bgDark}`}>Deployment Model</div><div className={`${styles.comparePill} ${styles.bgBlue}`}>Platform-native; perpetually self-improving after deployment</div>
                      <div className={`${styles.comparePill} ${styles.bgLightGrey}`}>Scale & Speed</div><div className={`${styles.comparePill} ${styles.bgBlue}`}>Real-time execution; instant cross-system synchronisation</div>
                      <div className={`${styles.comparePill} ${styles.bgDark}`}>Generative AI</div><div className={`${styles.comparePill} ${styles.bgBlue}`}>Production LLM deployment with RAG, fine-tuning & guardrails</div>
                    </div>
              ...
              {activeTab === 'services' && (
                <div className={styles.tabFadeIn}>
                  ...
                  <div className={styles.deepDiveHeaderBar} style={{marginBottom: '20px'}}>
                    <div className={styles.pillLeft}>SERVICE DEEP-DIVE &middot; {
                      activeService === 'ai-data' ? 'AI & DATA INTELLIGENCE' :
                      activeService === 'cloud-infra' ? 'CLOUD & INFRASTRUCTURE' :
                      activeService === 'cybersecurity' ? 'CYBERSECURITY' :
                      activeService === 'finance-risk' ? 'FINANCE & RISK MANAGEMENT' :
                      activeService === 'digital-eng' ? 'DIGITAL ENGINEERING & CUSTOMER OPERATIONS' :
                      activeService === 'emerging-tech' ? 'EMERGING TECHNOLOGY' :
                      'TALENT, STRATEGY & SUSTAINABILITY'
                    }</div>
                    <div className={styles.pillRight}>Corp Crunch™</div>
                  </div>
                  <div className={styles.capabilityGrid}>
                    <div className={`${styles.capabilitySmallCard} ${activeService === 'ai-data' ? styles.activeCapability : ''}`} onClick={() => setActiveService('ai-data')}>
                      <h4>AI & Data</h4>
                    </div>
                    <div className={`${styles.capabilitySmallCard} ${activeService === 'cloud-infra' ? styles.activeCapability : ''}`} onClick={() => setActiveService('cloud-infra')}>
                      <h4>Cloud & Infra</h4>
                    </div>
                    <div className={`${styles.capabilitySmallCard} ${activeService === 'cybersecurity' ? styles.activeCapability : ''}`} onClick={() => setActiveService('cybersecurity')}>
                      <h4>Cybersecurity</h4>
                    </div>
                    <div className={`${styles.capabilitySmallCard} ${activeService === 'finance-risk' ? styles.activeCapability : ''}`} onClick={() => setActiveService('finance-risk')}>
                      <h4>Finance & Risk</h4>
                    </div>
                    <div className={`${styles.capabilitySmallCard} ${activeService === 'digital-eng' ? styles.activeCapability : ''}`} onClick={() => setActiveService('digital-eng')}>
                      <h4>Digital Eng</h4>
                    </div>
                    <div className={`${styles.capabilitySmallCard} ${activeService === 'emerging-tech' ? styles.activeCapability : ''}`} onClick={() => setActiveService('emerging-tech')}>
                      <h4>Emerging Tech</h4>
                    </div>
                    <div className={`${styles.capabilitySmallCard} ${activeService === 'talent-strategy' ? styles.activeCapability : ''}`} onClick={() => setActiveService('talent-strategy')}>
                      <h4>Talent & Strategy</h4>
                    </div>
                  </div>

                  <div className={styles.dynamicContentArea}>
                    {activeService === 'ai-data' && (
                    ...
                    {activeService === 'cloud-infra' && (
                      <section id="cloud-infra" className={`${styles.section} ${styles.observeTrigger} ${visibleSections['cloud-infra'] ? styles.isVisible : ''}`}>
                        ...
                        <div className={styles.grid3x2}>
                          <div className={`${styles.serviceCard} ${styles.bgBlue}`}><h3>AI-Native Cloud Architecture</h3><p>Multi-cloud and hybrid deployments (AWS, Azure, GCP) designed to maximise throughput for ML inference, real-time analytics, and event-driven architectures.</p></div>
                          ...
                          <div className={`${styles.serviceCard} ${styles.bgBlue}`}><h3>Managed IT Services</h3><p>24/7 managed operations for cloud, on-premise, and hybrid estates. Proactive incident management with ML-driven anomaly detection and self-healing runbooks.</p></div>
                          ...
                          <div className={`${styles.serviceCard} ${styles.bgBlue}`}><h3>DevOps & Platform Engineering</h3><p>CI/CD pipelines, GitOps workflows, container orchestration (Kubernetes), and internal developer platforms that accelerate delivery velocity.</p></div>
                    ...
                    {activeService === 'cybersecurity' && (
                      <section id="cybersecurity" className={`${styles.section} ${styles.observeTrigger} ${visibleSections['cybersecurity'] ? styles.isVisible : ''}`}>
                        ...
                        <div className={styles.grid3x1}>
                          <div className={`${styles.serviceCardTall} ${styles.bgBlue}`}><h3>Threat Intelligence & SOC</h3><ul className={styles.bulletList}><li>AI-powered SIEM with real-time correlation</li><li>Automated threat hunting & IOC matching</li><li>ML-driven insider threat detection</li><li>24/7 managed SOC with sub-5-min MTTD</li></ul></div>
                    ...
                    {activeService === 'finance-risk' && (
                      <section id="finance-risk" className={`${styles.section} ${styles.observeTrigger} ${visibleSections['finance-risk'] ? styles.isVisible : ''}`}>
                        ...
                        <div className={styles.splitLayout2Col}>
                          <div className={styles.splitLeft}>
                            <div className={`${styles.listPillColor} ${styles.bgBlue}`}><strong>Advanced Risk Modeling</strong><p>Multi-factor credit, market, and operational risk models with real-time scoring, stress testing, and scenario simulation.</p></div>
                            ...
                            <div className={`${styles.listPillColor} ${styles.bgBlue}`}><strong>Regulatory Intelligence & Reporting</strong><p>Automated generation and submission of regulatory reports (Basel IV, IFRS 9, FRTB, MiFID II) with AI-assisted exception handling.</p></div>
                    ...
                    {activeService === 'digital-eng' && (
                      <section id="digital-eng" className={`${styles.section} ${styles.observeTrigger} ${visibleSections['digital-eng'] ? styles.isVisible : ''}`}>
                        ...
                        <div className={styles.grid2x2}>
                          <div className={`${styles.serviceCardTall} ${styles.bgBlue}`}><h3>Digital Engineering & Manufacturing</h3><ul className={styles.bulletList}><li>Digital twin design & simulation</li><li>Smart factory & Industry 4.0 enablement</li><li>Predictive maintenance with edge ML</li><li>Product lifecycle intelligence (PLM/ALM)</li><li>Embedded systems & firmware intelligence</li></ul></div>
              ...
              {activeTab === 'engagement' && (
                <div className={styles.tabFadeIn}>
                  <section id="delivery" className={`${styles.section} ${styles.observeTrigger} ${visibleSections['delivery'] ? styles.isVisible : ''}`}>
                    ...
                    <div className={styles.grid3x1}>
                      ...
                      <div className={`${styles.deliveryCard} ${styles.bgBlue}`}>
                        ...
                        <div className={`${styles.deliveryFooter} ${styles.bgLightBlue} ${styles.textWhite}`}>✓ Enterprise-wide AI transformation</div>
                      </div>
                  ...
                  <section id="why-choose" className={`${styles.section} ${styles.observeTrigger} ${visibleSections['why-choose'] ? styles.isVisible : ''}`}>
                    ...
                    <div className={styles.grid3x1}>
                      <div className={`${styles.whyCard} ${styles.bgBlue}`}><div className={styles.whyHeader}><span className={styles.numBadge}>1</span><h3>Faster Decisions</h3></div><p>Real-time data orchestration and predictive analytics compress decision cycles from days to milliseconds.</p></div>
            ...
            <section id="footer-contact" className={styles.footerContactSection}>
              <div className={styles.footerGrid}>
                <div className={styles.footerColWhite}>
                  ...
                  <div className={styles.contactItem}><div className={`${styles.contactLine} ${styles.lineBlue}`}></div><div><strong>Email</strong><p>founder@corpcrunch.io<br/>scoop@corpcrunch.io</p></div></div>
